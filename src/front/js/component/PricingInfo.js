        ...
        <div className="">
            ...
            <div className="col-8 pricing" style={{padding: "30px"}}>
                ...
                <div className="row pricing1" style={{justifyContent: "center"}}> 
                    {/* <!-- service-block-two --> */}
                    <div className="service-block-two col-lg-4 col-sm-6 wow fadeInUp m-5" data-wow-delay="400ms" style={{border: "white 1px solid", borderRadius: "5px", width: "200px", height: "200px", boxShadow: `0px 4px 8px 0px #ffaa17`}}>
