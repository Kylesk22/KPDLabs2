...
export const PricingInfo = props => {
    ...
    `}}>Crowns Starting at <h2 style={{color: "white"}}>$40</h2></a></h4>                 
                    ...
                    <div className="inner-box" onClick={()=>setType("denture")}>
                        ...
                        <div className="content-box text-center">
                        <h4 className="title"><a style={{color: "white"}}>Dentures starting at <h2 style={{color: "white"}}>$250</h2></a></h4>
                        </div>
                    </div>
                    </div>
                    <div className="service-block-two col-lg-4 col-sm-6 wow fadeInUp m-5" data-wow-delay="800ms" style={{border: "#ffaa17 1px solid", borderRadius: "5px", width: "200px", height: "200px", boxShadow: `0px 0px 6px 8px #ffaa17`}}>
    ...
    `}}>Email address</label>
                ...
                <div className="form-group mx-3">
                        ...
                        <label  htmlFor="findUs"style={{color: "white"}}>Professional Position?</label>
                ...
                <div className="form-group mx-3">
                        ...
                        <label  htmlFor="findUs"style={{color: "white"}}>How did you hear about us?</label>
