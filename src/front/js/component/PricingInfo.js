    ...
    return(
        <div className="">
            ...
            <div className="col-8 pricing" style={{padding: "30px"}}>
                ...
                <div className="row "> 
                    {/* <!-- service-block-two --> */}
                    <div className="service-block-two col-lg-3 col-sm-6 wow fadeInUp m-2" data-wow-delay="400ms" style={{border: "white 1px solid", borderRadius: "5px"}}>
                    ...
                    {/* <!-- service-block-two --> */}
                    <div className="service-block-two col-lg-3 col-sm-6 wow fadeInUp m-2" data-wow-delay="600ms" style={{border: "white 1px solid", borderRadius: "5px"}}>
                    ...
                    {/* <!-- service-block-two --> */}
                    <div className="service-block-two col-lg-3 col-sm-6 wow fadeInUp m-2" data-wow-delay="800ms" style={{border: "white 1px solid", borderRadius: "5px"}}>
