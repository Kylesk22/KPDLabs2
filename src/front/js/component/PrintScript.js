...
export const PrintPDFButton = (props) => {
    ...
    const handlePrint = () => {
        ...
        const printContent = `
            ...
            <body>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="info-data inline-container">
                            <div>
                                <div>Ship to Address:</div><div> ${props.street}</br>${props.city}, ${props.state} ${props.zip}</div>
                            </div>
                        ...
                        <div class="inline-container-2 info-data">
                            ...
                            <div class="text-right">                                             
                                ...
                                <div id = "finish" class="info-data-3 hide">Finish: ${props.finish}</div>
                                ...
                                <div id = "dueDate" class="info-data-3 hide">In-Lab Due Date: ${props.dueDate}</div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        if ('${props.finish}' !== "" && '${props.finish}' && '${props.finish}' !== "N/A"){
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        if ('${props.dueDate}' !== "" && '${props.dueDate}' && '${props.dueDate}' !== "undefined"){
    ...
    return (
        <button class="theme-btn" onClick={handlePrint}>Print PDF</button>
    );
};
