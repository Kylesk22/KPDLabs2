  ...
  <section className="team-section" >
    <div className="auto-container">
      ...
      <div className="row" style={{paddingTop: "50px"}}> 
        ...
        <div style={{border: "4px solid #ffaa17", marginRight: "2px"}} className="col-5 text-center">
        ...
        <div style={{border: "4px solid #ffaa17", marginLeft: "2px"}} className="col-5 text-center">
