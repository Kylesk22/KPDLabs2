        ...
        <div className="row">
            ...
            <div className="lg-col-4 sm-col-8 text-center" >
                ...
                <div className="form-group mx-3">
                        ...
                        <button className="btn btn-primary mb-4 mx-auto" onClick={(e)=>{e.preventDefault();setEditStreet(true)}}>Edit</button>
                        {(editStreet)?
                    ...
                    <div className="form-group mx-3">
                        ...
                        <button className="btn btn-primary mb-4 mx-auto" onClick={(e)=>{e.preventDefault();setEditCity(true)}}>Edit</button>
                        {(editCity)?
                    ...
                    <div className="form-group mx-3">
                        ...
                        <button className="btn btn-primary mb-4 mx-auto" onClick={(e)=>{e.preventDefault();setEditState(true)}}>Edit</button>
                        {(editState)?
