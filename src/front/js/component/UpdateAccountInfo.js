        ...
        <div className="row">
            ...
            <div className="lg-col-4 sm-col-8 text-center" >
                ...
                <div className="form-group mx-3">
                        ...
                        <button className="btn btn-primary mb-4 mx-auto" onClick={()=>setEditStreet(true)}></button>
                        {(editStreet)?
                    ...
                    <div className="form-group mx-3">
                        ...
                        <button className="btn btn-primary mb-4 mx-auto" onClick={()=>setEditCity(true)}></button>
                        {(editCity)?
                    ...
                    <div className="form-group mx-3">
                        ...
                        <button className="btn btn-primary mb-4 mx-auto" onClick={()=>setEditState(true)}></button>
                        {(editState)?
                    ...
                    <div className="form-group mx-3">
                        ...
                        <button className="btn btn-primary mb-4 mx-auto" onClick={()=>editZip(true)}></button>
                        {(editZip)?
