  ...
  function getCookie(name) {
	...
	return (
		...
		<header className="main-header header-style-one" >
			...
			<div className="logo"><a href="/"><img src="/kpd_logo_final.svg" alt="" style={{height: "70px", width: "auto"}}/></a></div>
	...
	<div className={`${mobileActive ? 'mobile-menu-visible' : ''}`} >
		...
		<nav className="menu-box">
			...
			<div className="nav-logo" ><a href="/"><img src="/kpd_logo_final.svg" alt="" style={{height: "70px", width: "auto"}}/></a></div>
