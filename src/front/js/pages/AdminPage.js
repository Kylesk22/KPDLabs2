                                    ...
                                    <>
                                        ...
                                        <div className = "col-1 text-center" style={{border: "solid black 1px", color:"black", backgroundColor:(item["production"] === "Rush" && item["shipping"] === "Express")? "red":(item["shipping"] === "Express")? "yellow" :(item["production"] === "Rush")? "orange" : (item["hold"])? "pink" : (index % 2 === 1)? "rgba(0, 0, 0, .125)" : "white"}}>{item["update date"] ? 
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        <div className="col-1 text-center" style={{
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            color: "black",
                                                                                                                                                                                                                                                                                                                                                                            backgroundColor: (item["production"] === "Rush" && item["shipping"] === "Express") ? "red" :
                                                                                                                                                                                                                                                                                                                                                                                (item["shipping"] === "Express") ? "yellow" :
                                                                                                                                                                                                                                                                                                                                                                                (item["production"] === "Rush") ? "orange" :
                                                                                                                                                                                                                                                                                                                                                                                (item["hold"]) ? "pink" :
                                                                                                                                                                                                                                                                                                                                                                                (index % 2 === 1) ? "rgba(0, 0, 0, .125)" : "white"
                                                                                                                                                                                                                                                                                                                                                                        }}>
                                                                                                                                                                                                                                                                                                                                                                            {item["due date"] ? 
                                                                                                                                                                                                                                                                                                                                                                                (() => {
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    // Add additional days only if there's a hold
                                                                                                                                                                                                                                                                                                                                                                                    if (item["hold"]) {
