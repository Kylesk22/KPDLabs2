                            ...
                            <div key={index} className="row" >
                                ...
                                {(index <= pageMax && index >= pageMin)?
                                    ...
                                    <>
                                        ...
                                        <div className = "col-1 text-center" style={{border: "solid black 1px", color:"black", backgroundColor:(index % 2 === 1)? "rgba(0, 0, 0, .125)" : (item["production"] === "Rush")? "red" : "white"}} >{item["id"]}</div>
                                        <div className = "col-3 text-center" style={{border: "solid black 1px", color:"black", backgroundColor:(index % 2 === 1)? "rgba(0, 0, 0, .125)" : (item["production"] === "Rush")? "red" : "white"}}>{users[`${item["user id"]}`]}</div>
                                        <div className = "col-3 text-center" style={{border: "solid black 1px", color:"black", backgroundColor:(index % 2 === 1)? "rgba(0, 0, 0, .125)" : (item["production"] === "Rush")? "red" : "white"}}>{item["name"]}</div>
                                        <div className = "col-2 text-center" style={{border: "solid black 1px", color:"black", backgroundColor:(index % 2 === 1)? "rgba(0, 0, 0, .125)" : (item["production"] === "Rush")? "red" : "white"}}>{item["type"]}</div>
                                        <div className = "col-2 text-center" style={{border: "solid black 1px", color:"black", backgroundColor:(index % 2 === 1)? "rgba(0, 0, 0, .125)" : (item["production"] === "Rush")? "red" : "white"}}>{item["update date"]}</div>
                                        <div className = "col-1 text-center" style={{border: "solid black 1px", color:"black", backgroundColor:(index % 2 === 1)? "rgba(0, 0, 0, .125)" : (item["production"] === "Rush")? "red" : "white"}}>{item["status"]}</div>
                                    </>
