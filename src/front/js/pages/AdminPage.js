                            ...
                            <div key={index} className="row" >
                                ...
                                {(index <= pageMax && index >= pageMin)?
                                    ...
                                    <>
                                        ...
                                        {(showBulkBox)?
                                            <div className = "col-1 text-center" onClick={(e) => {e.preventDefault(); e.stopPropagation(); setBulkCases(...bulkCases, item["id"]); (caseChecked)? setCaseChecked(false): setCaseChecked(true)}}  style={{border: "solid black 1px", color:"black", backgroundColor:"white"}}>{(caseChecked)?<i className="fa-regular fa-square-check"></i>: <i className="fa-regular fa-square"></i>}</div>
                                            :
                                            ""
                                        }
