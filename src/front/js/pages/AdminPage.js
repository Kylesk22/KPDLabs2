...
export const AdminPage = props => {
    ...
    useEffect(()=>{
        ...
        <div className="container">
            ...
            <div>
                Legend: <i className="fa-solid fa-square" style={{color:"orange"}}></i> Rush Production | <i className="fa-solid fa-square" style={{color:"yellow", paddingLeft: "2px"}}></i> Rush Shipping |<i className="fa-solid fa-square" style={{color:"red", paddingLeft: "2px"}}></i> Rush Production and Shipping
            </div>
                            ...
                            <div key={index} className="row" >
                                ...
                                {(index <= pageMax && index >= pageMin)?
                                    ...
                                    <>
                                        ...
                                        <div className = "col-2 text-center" style={{border: "solid black 1px", color:"black", backgroundColor:(item["production"] === "Rush")? "red" : (index % 2 === 1)? "rgba(0, 0, 0, .125)" : "white"}}>{item["update date"]}</div>
                                        <div className = "col-1 text-center" style={{border: "solid black 1px", color:"black", backgroundColor:(item["production"] === "Rush")? "red" : (index % 2 === 1)? "rgba(0, 0, 0, .125)" :  "white"}}>{item["status"]}</div>
                                    </>
