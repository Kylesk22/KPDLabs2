     ...
     id="path44" />
                ...
                <div className="row form-group justify-content-center no-print">
                    ...
                    {cases.map((item, index) => {
                        ...
                        return (
                            <div key={index} className="row form-group justify-content-center no-print" style={{backgroundColor, width: "50%"}} onClick={()=>{handleSelectedCasesColor(item["id"])}}>{item["id"]}
                            </div>
                    )})}
