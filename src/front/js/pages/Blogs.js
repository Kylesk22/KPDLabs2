      ...
      <div className="row" style={{paddingTop: "50px"}}> 
        ...
        <div className="col-lg-4 col-md-6 col-sm-12" >
          <div className="blog-post ">
            ...
            <div className="">
              <h4 className="blog-text"  style={{color: "black"}}><a href="/blogs/blog2">The Clinical Hygiene Benefits of Highly Polished Zirconia Crowns for Posterior Restorations
</a></h4>
