...
<div className="page-wrapper">
  ...
  <section className="contact-us-page banner-slide" style={{backgroundImage: `url(${Intro})`, position: "relative", backgroundSize: "cover", backgroundRepeat: "no-repeat", marginTop: "125px", padding: "110px, 0, 110px", minHeight: "350px"}}>
						...
						<ul className="list-unstyled contact-details__info">
							<li>
								...
								<div className="text">
									...
									<a href="tel:863-438-2109">863-438-2109</a>
								</div>
							</li>
							<li>
								<div className="icon">
